...
{
    [UsedImplicitly]
    public class SearchFanburstUserSource : ISource<BaseUser>
    {
        /// <summary>
            ...
            CancellationTokenSource cancellationToken = default(CancellationTokenSource))
        {
            ...
            var users = await SoundByteV3Service.Current.GetAsync<List<FanburstUser>>(ServiceType.Fanburst, "users/search",
